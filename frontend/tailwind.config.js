  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "tandoor-platinum": "#E5E5E5", // Replacing gold with platinum
        "tandoor-ivory": "#F4F4F4",  // Off-white for body text
        "tandoor-offwhite": "#F5F5F5",
        "tandoor-charcoal": "#2A2A2A",
        "tandoor-black": "#0A0A0A",
        "tandoor-red": "#D9534F", // Red color for featured items and highlights
