  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: PremiumTheme.colors.background.primary, color: PremiumTheme.colors.text.primary }}>
      ...
      <section className="relative h-[40dvh] md:h-[60dvh] flex items-center">
        ...
        <div className="container mx-auto px-4 relative z-20">
          ...
          <p className="text-xl max-w-xl" style={{ color: PremiumTheme.colors.text.secondary }}>
            Discover the heritage, passion, and people behind Cottage Tandoori's four decades of authentic Indian cuisine.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2 grid grid-cols-2 gap-4">
              ...
              />
              <img 
                src="https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/THALI OF SPICES.png" 
                alt="Traditional spices" 
                className="rounded-lg shadow-2xl w-full h-auto mt-12"
              />
              <img 
                src="https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/VERANDA VIEW.jpg" 
                alt="Restaurant view" 
                className="rounded-lg shadow-2xl w-full h-auto"
              />
              <img 
                src="https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/TABLE 6 STRIGHT VIEW.jpg" 
      ...
      <section className="py-16 px-4 relative overflow-hidden" style={{ backgroundColor: PremiumTheme.colors.background.primary }}>
        <div className="absolute inset-0 opacity-10 bg-[url('https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/OLD NEWSPAPER ARTICLES COLLAGE.png')] bg-repeat"></div>
              ...
              {[
                {
                  ...
                  image: "https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/OLD NEWSPAPER ARTICLES 1.png"
                },
                {
                  ...
                  image: "https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/OLD NEWSPAPER ARTICLES 2.png"
                },
                {
                  ...
                  image: "https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/OLD NEWSPAPER ARTICLES 3.png"
                },
                {
                  ...
                  image: "https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/OLD NEWSPAPER ARTICLES 4.png"
                },
                {
                  ...
                  image: "https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/OLD NEWSPAPER ARTICLES 5.png"
                },
                {
                  ...
                  image: "https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/OLD NEWSPAPER ARTICLES 6.png"
                },
                {
                  ...
                  image: "https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/OLD NEWSPAPER ARTICLES 7.png"
                }
              ].map((article, index) => (
                <div 
                  key={index} 
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-[#e8e6d9]">
                    ...
                    <div className="absolute inset-0 bg-[url('https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/paper-texture.jpg')] opacity-15 mix-blend-overlay pointer-events-none"></div>
                  </div>
            ...
            <div className="p-6 overflow-auto max-h-[calc(90dvh-4rem)]" style={{
              ...
              <div className="relative rounded-lg p-4" style={{
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-[url('https://static.databutton.com/public/6d13cbb4-0d00-46ec-8ef0-98e0a8405532/paper-texture.jpg')] opacity-5 mix-blend-overlay pointer-events-none"></div>
                </div>
              </div>
            </div>
          </div>
