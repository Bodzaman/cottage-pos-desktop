  ...
  useEffect(() => {
    const createOrder = async () => {
      ...
      try {
        ...
        const response = await brain.create_online_order(orderPayload);
    ...
    try {
      ...
      if (checkoutData && createdOrderId) {
        ...
        try {
          ...
          const response = await brain.get_template_assignment({ orderMode: apiOrderMode });
  ...
  return (
    <div className="min-h-screen bg-[#0B0C0E] text-[#EAECEF] relative">
      ...
      <div 
        className="absolute inset-0 bg-center bg-no-repeat opacity-20 brightness-110"
        style={{
          backgroundImage: `url('https://static.databutton.com/public/88a315b0-faa2-491d-9215-cf1e283cdee2/SIDE 1_TRANSPARENT_BG_BLUE_TINT.png')`,
          backgroundSize: 'cover',
          backgroundPosition: 'center center'
        }}
      />
