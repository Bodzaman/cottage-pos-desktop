...
export class Brain<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags dbtn/module:github_kds_manager
   * @name check_kds_health
   * @summary Check KDS Health
   * @request GET:/routes/kds-health
   */
  check_kds_health = (params: RequestParams = {}) =>
  ...
  /**
   * @description Command: Create new dine-in order - Creates order in CREATED state - Links to table - Updates table status to OCCUPIED - Logs ORDER_CREATED event
   *
  ...
  /**
   * @description Command: Add item to order - Validates order is editable (CREATED or SENT_TO_KITCHEN states) - Adds item to items array - Recalculates totals - Logs ITEM_ADDED event
   *
   * @tags dbtn/module:dine_in_commands
  ...
  /**
   * @description Command: Remove item from order - Validates order is editable - Removes item by ID - Recalculates totals - Logs ITEM_REMOVED event
   *
   * @tags dbtn/module:dine_in_commands
  ...
  /**
   * @description Command: Send order to kitchen - Validates state transition (CREATED → SENT_TO_KITCHEN) - Updates order status - Updates table status to DINING - Returns success (print job creation handled separately)
   *
   * @tags dbtn/module:dine_in_commands
