...
export interface AddItemCommand {
  /** Order Id */
  order_id: string;
  item: AppApisDineInCommandsOrderItem;
}
...
export interface CreateRepositoryRequest {
  ...
  /**
   * Homepage
   * @default "Set via APP_BASE_URL environment variable"
   */
  homepage?: string;
  /**
   * Has Issues
 ...
 * Complete dependency tree analysis results
 */
export interface DependencyAnalysisResponse {
  /** Total Files Analyzed */
  total_files_analyzed: number;
  /** Total Imports Found */
  total_imports_found: number;
  /** Npm Packages Needed */
...
/**
 * NPMPackageComparison
 * Comparison between Databutton and GitHub npm packages
 */
export interface NPMPackageComparison {
  /** Databutton Packages */
  databutton_packages: Record<string, string>;
  /** Github Packages */
  github_packages: Record<string, string>;
  /** Missing In Github */
  missing_in_github: string[];
  /** Extra In Github */
  extra_in_github: string[];
  /** Version Mismatches */
  version_mismatches: Record<string, string>[];
}
...
export interface OrderResponse {
  ...
  status: string;
  /** Items */
  items: AppApisDineInCommandsOrderItem[];
  /** Subtotal */
  subtotal: number;
  /** Tax */
  tax: number;
...
/** RequestCheckCommand */
export interface RequestCheckCommand {
  /** Order Id */
  order_id: string;
}
...
/** OrderItem */
export interface AppApisDineInCommandsOrderItem {
  /** Id */
  id: string;
  /** Name */
  name: string;
...
export interface AppApisUnifiedTestPrintTestPrintResponse {
  ...
  /**
   * Timestamp
   * @default "2025-12-05T16:30:58.614367"
   */
  timestamp?: string;
  /** Job Id */
  job_id?: string | null;
...
/** UpdateOrderNotesResponse */
export interface UpdateOrderNotesResponse {
  /** Success */
  success: boolean;
  /** Message */
  message: string;
...
export type UpdateOrderNotesData = UpdateOrderNotesResponse;

export type UpdateOrderNotesError = HTTPValidationError;
...
export type AnalyzePosDesktopDependenciesData = DependencyAnalysisResponse;

export type CompareNpmPackagesData = NPMPackageComparison;
...
export type AddItemToOrderData = OrderResponse;

export type AddItemToOrderError = HTTPValidationError;

export type RemoveItemFromOrderData = OrderResponse;

export type RemoveItemFromOrderError = HTTPValidationError;

/** Response Send To Kitchen */
export type SendToKitchenData = Record<string, any>;

export type SendToKitchenError = HTTPValidationError;

/** Response Request Check */
export type RequestCheckData = Record<string, any>;

export type RequestCheckError = HTTPValidationError;

/** Response Mark Paid */
export type MarkPaidData = Record<string, any>;

export type MarkPaidError = HTTPValidationError;

// ============================================================================
// ORDER ITEM TYPES
// Added for DineInFullReviewModal parity with Electron version
// ============================================================================

/**
 * Basic order item for POS
 */
...
export interface EnrichedDineInOrderItem {
  ...
  menu_item_description?: string | null;
  // Kitchen display name for thermal receipt printing (abbreviated name)
...
/**
 * Dine-in order object with full details
 */
