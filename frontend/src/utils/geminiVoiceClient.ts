 ...
 *   3. Frontend uses: @google/genai SDK to connect DIRECTLY to Google's servers
...
Always use functions to perform cart operations.`;
  ...
  private async handleGetCartSummary(functionCall: any): Promise<void> {
    try {
      // Note: This handler uses the injected cart operations now
      // The useCartStore reference is kept for backward compatibility
      const { useCartStore } = await import('utils/cartStore');
  ...
  private async handleSearchMenu(functionCall: any): Promise<void> {
    try {
      ...
      const resp = await brain.search_menu({
  ...
  private async handleGetMenuItemsWithVariants(functionCall: any): Promise<void> {
    try {
      ...
      // TODO: Update Brain SDK to include get_menu_items_with_variants endpoint
      const resp = await (brain as any).get_menu_items_with_variants({
  ...
  private async handleGetItemCustomizations(functionCall: any): Promise<void> {
    try {
      ...
      // TODO: Update Brain SDK to include get_item_customizations endpoint
      const resp = await (brain as any).get_item_customizations({
  ...
  private async handleGetRestaurantInfo(functionCall: any): Promise<void> {
    try {
      ...
      // TODO: Update Brain SDK to include get_restaurant_info endpoint
      const resp = await (brain as any).get_restaurant_info();
      const data = await resp.json();
  ...
  private async handleCheckDeliveryZone(functionCall: any): Promise<void> {
    try {
      ...
      // TODO: Update Brain SDK to include check_delivery_zone endpoint
      const resp = await (brain as any).check_delivery_zone({
  ...
  private async handleCreateOrder(functionCall: any): Promise<void> {
    try {
      ...
      // TODO: Update Brain SDK to include create_order endpoint with correct signature
      const resp = await (brain as any).create_order({
        items: args.items || [],
  ...
  private async handleGetItemVariants(functionCall: any): Promise<void> {
    try {
      ...
      // TODO: Update Brain SDK to include get_item_variants endpoint
      const resp = await (brain as any).get_item_variants({
        item_id: args.item_id
      });
      const data = await resp.json();
