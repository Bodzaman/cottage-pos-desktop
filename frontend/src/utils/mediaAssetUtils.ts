...
import { getMediaAsset, updateMediaAsset as updateMediaAssetQuery } from './supabaseQueries';
...
export const fetchMediaAssetDetails = async (assetId: string): Promise<{
  ...
  try {
    // Direct Supabase query - replaces brain.get_media_asset()
...
export const updateMediaAssetUsage = async (
  ...
  try {
    // Direct Supabase update - replaces brain.update_media_asset()
