...
export const checkStorageBuckets = async () => {
  try {
    const response = await (brain as any).check_bucket_status();
...
export const initializeStorageBuckets = async () => {
  try {
    const response = await (brain as any).initialize_storage_buckets();
    const data = await response.json();
...
export const migrateWebsiteImages = async () => {
  try {
    const response = await (brain as any).migrate_images({
...
export const checkMigrationStatus = async () => {
  try {
    const response = await (brain as any).get_migration_status();
