...
export const fetchHierarchicalMedia = async (): Promise<HierarchicalMediaData> => {
  try {
    const response = await (brain as any).get_hierarchical_media({});
...
export const fetchMenuSections = async (): Promise<MenuSection[]> => {
  try {
    const response = await (brain as any).get_menu_categories({});
  ...
  try {
    ...
    switch (assetCategory) {
      case 'menu-item':
        ...
        response = await (brain as any).upload_menu_image({
          file,
      ...
      case 'ai-avatar':
        response = await (brain as any).upload_avatar({
          file,
          asset_category: assetCategory,
        });
        break;
      ...
      case 'general':
      default:
        response = await (brain as any).upload_general({
          file,
          asset_category: assetCategory,
        });
        break;
