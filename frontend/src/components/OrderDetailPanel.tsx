...
import { AlertTriangle, UserCheck, UserIcon, Phone, Headphones, AlertCircle } from 'lucide-react';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/components/ui/accordion";
import { ScrollArea } from "@/components/ui/scroll-area";
import { extractItemName, extractVariantName, extractQuantity } from '../utils/orderDisplayUtils';
  ...
  return (
    <div className={`h-full overflow-y-auto ${className}`}>
      ...
      <div className="mb-6">
        ...
        {/* Customer info - use individual fields from CompletedOrder */}
        ...
        {isVoiceOrder && order.confidence_score !== undefined && (
          <div className="mt-4 space-y-2 rounded-md p-3" style={{
            ...
            <div className="flex justify-between items-center">
              ...
              {getConfidenceIndicator(order.confidence_score)}
            </div>
          </div>
        )}
        ...
        {isVoiceOrder && (
          <div className="flex items-center gap-1 my-3" style={{ color: designColors.text.secondary }}>
            ...
            <span className="text-xs">Voice Order</span>
          </div>
        )}
      ...
      >
        ...
        <div className="space-y-2">
          ...
          {(typeof window !== 'undefined' && (window as PosSettingsWindow).posSettings?.vat?.show_breakdown !== false) && (
            <div className="flex justify-between">
              <span style={{ color: designColors.text.secondary }}>
                VAT ({typeof window !== 'undefined' && (window as PosSettingsWindow).posSettings?.vat ? (window as PosSettingsWindow).posSettings!.vat!.percentage : 20}%, included)
              </span>
...
// Type for accessing posSettings with vat on window
interface PosSettingsWindow {
  posSettings?: {
    vat?: {
