...
export default function NotificationBadge({ 
  ...
  const loadNotificationStats = async () => {
    try {
      ...
      const response = await brain.get_realtime_notification_stats(params);
  ...
  const loadNotifications = async () => {
    try {
      ...
      const response = await brain.get_realtime_notifications(params);
  ...
  const markNotificationsAsRead = async (notificationIds: string[]) => {
    try {
      const response = await brain.mark_realtime_notifications({
