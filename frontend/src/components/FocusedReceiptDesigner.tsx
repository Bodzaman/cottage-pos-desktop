...
import {
  ...
  Receipt, DollarSign, Info, Building, Plus, Settings,
  Trash2, Save,
...
import { generateSampleItems } from 'utils/thermalPreview';
...
// Element category type for industry standard categorization
type ElementCategory = 'kitchen_only' | 'customer_only' | 'both';
