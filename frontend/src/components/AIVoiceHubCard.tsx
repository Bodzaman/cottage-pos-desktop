...
import type { VoiceAgentStatusResponse } from '@/brain/data-contracts';
import { eventBus, EVENTS } from 'utils/eventBus';
import { colors, cardStyle } from 'utils/designSystem';

const AIVoiceHubCard: React.FC = () => {
  const { data: status, isLoading, error, refetch } = useQuery<VoiceAgentStatusResponse>({
    queryKey: ['voiceAgentStatus'],
    queryFn: async () => {
            ...
            <div className="relative h-48 rounded border overflow-hidden bg-gradient-to-br from-purple-900/20 to-blue-900/20" style={{ borderColor: colors.border.light }}>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative">
                  ...
                  {/* Avatar image */}
                  <img 
                    src="https://static.databutton.com/public/2c7eeed4-396b-46e1-a316-2b5a4723e8f0/waiter_1.png"
