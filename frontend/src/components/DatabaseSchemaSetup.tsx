...
export function DatabaseSchemaSetup({ className = '', onComplete }: Props) {
  ...
  const checkSchemaStatus = async () => {
    ...
    try {
      ...
      // TODO: Update Brain SDK to include check_dining_tables_schema endpoint
      const diningTablesResponse = await (brain as any).check_dining_tables_schema();
  ...
  const setupDatabaseSchema = async () => {
    ...
    try {
      ...
      // TODO: Update Brain SDK to include setup_dining_tables_schema endpoint
      const diningTablesResponse = await (brain as any).setup_dining_tables_schema();
      const diningTablesData = await diningTablesResponse.json();
