...
// Define dashboard stats type to avoid module import issues
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="border-0 overflow-hidden" style={cardStyle}>
            ...
            <div className="h-1 w-full bg-gradient-to-r" style={{ background: `linear-gradient(to right, ${colors.status.success}, ${colors.brand.turquoise})` }}></div>
          </Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-4 rounded-lg bg-gray-900/50 border border-gray-800 flex items-center justify-between">
                ...
                <div className="h-16 w-16 rounded-full flex items-center justify-center" style={{backgroundColor: "rgba(66, 133, 244, 0.1)"}}>
              ...
              <div className="p-4 rounded-lg bg-gray-900/50 border border-gray-800 flex items-center justify-between">
                ...
                <div className="h-16 w-16 rounded-full flex items-center justify-center" style={{backgroundColor: "rgba(175, 139, 244, 0.1)"}}>
              ...
              <div className="p-4 rounded-lg bg-gray-900/50 border border-gray-800 flex items-center justify-between">
                ...
                <div className="h-16 w-16 rounded-full flex items-center justify-center" style={{backgroundColor: "rgba(255, 171, 46, 0.1)"}}>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4 p-3 rounded-lg" style={{backgroundColor: "rgba(30, 35, 50, 0.5)"}}>
                <div className="h-10 w-10 rounded-full flex items-center justify-center" style={{backgroundColor: "rgba(99, 226, 183, 0.2)"}}>
                  <Calendar className="h-5 w-5" style={{color: colors.brand.turquoise}} />
                </div>
                <div className="flex-1">
