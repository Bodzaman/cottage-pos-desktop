...
// Stub component for POSManualCardEntry (component not implemented)
// TODO: Implement proper Stripe manual card entry component
interface POSManualCardEntryProps {
  ...
  tipAmount: number;
  onSuccess: (paymentIntent: any, amount: number) => void;
  onError: (error: string) => void;
  onCancel: () => void;
}

const POSManualCardEntry: React.FC<POSManualCardEntryProps> = ({
  orderTotal,
  onCancel,
  onError
}) => {
  return (
    <div className="p-6 text-center">
      <p className="text-gray-400 mb-4">Manual card entry is not currently available.</p>
      <p className="text-gray-500 text-sm mb-4">Please use the Adyen terminal or cash payment.</p>
