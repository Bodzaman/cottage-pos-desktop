import { KitchenOrderItem, KitchenOrderStatus } from "utils/kitchenTypes";
import { Badge } from "@/components/ui/badge";
import cn from "classnames";

// Extended item type with optional status tracking properties
interface OrderItemWithStatus extends KitchenOrderItem {
...
const isItemNew = (item: OrderItemWithStatus): boolean => {
