      ...
      try {
        ...
        if (content.length > maxLength) {
          errors.push({
            ...
            message: `Content truncated from ${content.length} to ${maxLength} characters`,
            severity: 'warning'
          });
        ...
        return {
          ...
          style: {
            ...
            size: thermalSize,
            doubleHeight: element.style?.double_height || false,
            doubleWidth: element.style?.double_width || false,
            underline: element.style?.text_decoration === 'underline',
            inverse: element.style?.inverse || false
          },
          spacing: {
        ...
        errors.push({
          elementId: element.id,
          message: `Conversion error: ${err instanceof Error ? err.message : 'Unknown error'}`,
          severity: 'error'
        });
        ...
        return {
          id: element.id,
          content: '[Error: Could not convert element]',
          charWidth,
          align: 'left' as const,
          style: {
            bold: false,
