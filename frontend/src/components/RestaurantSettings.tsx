...
import { useRestaurantSettings, OpeningHours, DeliverySettings, KitchenStatus, RestaurantSettings as RestaurantSettingsType } from "utils/useRestaurantSettings";
...
export const RestaurantSettings: React.FC<Props> = () => {
  ...
  const [editableSettings, setEditableSettings] = useState<Partial<RestaurantSettingsType>>(settings || {});
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <NumberInput
                      ...
                      className="flex-1"
                      dropdownOptions={[1, 2, 3, 4, 5, 6, 8, 10, 12]}
                    />
                    <div className="flex items-center">
