...
const OnlineMenuModal: React.FC<OnlineMenuModalProps> = ({ isOpen, onClose }) => {
  ...
  } = useCompleteMenuData({ queryKey: ['completeMenu'], enabled: isOpen });
  ...
  // Local state for menu items (for optimistic updates)
  const [localMenuItems, setMenuItems] = useState<MenuItem[]>([]);
  const [setMeals, setSetMeals] = useState<SetMealListResponse[]>([]);
                ...
                <Tabs value={activeCategory} onValueChange={setActiveCategory} className="w-full">
                        ...
                        >
                          ...
                          <div className="flex gap-4 mb-4">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {item.description && item.description !== item.menu_item_description && (
                                <p
                  ...
                  {setMeals.length > 0 && (
                    <div className="mt-12">
                      ...
                      <SetMealsSection
                        userRole={isEditMode ? 'editor' : 'viewer'}
                      />
                    </div>
                  )}
                </Tabs>
