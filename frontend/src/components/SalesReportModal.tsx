...
import { BarChart3, TrendingUp, DollarSign, Users, Clock, Download, FileText, Calendar, RefreshCw, Lock, PieChart, Printer, ArrowUpRight, CreditCard } from 'lucide-react';
...
export function SalesReportModal({ isOpen, onClose }: SalesReportModalProps) {
  ...
  useEffect(() => {
    ...
    const unsubscribe = useSettingsStore.subscribe(
      (state) => {
        const password = state.settings.salesReportPassword;
  ...
  return (
    <StrictDialog open={isOpen} onOpenChange={(open) => { if (!open) handleClose(); }}>
            ...
            <DialogHeader className="print:pb-6 print:border-b print:border-gray-200">
              ...
              <DialogDescription className="text-gray-400 print:text-gray-600">
                ...
                <span className="hidden print:block">
                  Generated on <SafeDate value={new Date()} format="date" /> at <SafeDate value={new Date()} format="time" />
                </span>
              </DialogDescription>
            </DialogHeader>
