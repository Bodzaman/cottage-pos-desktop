import {
  ...
  AddPrintTemplateData,
  AddPrintTemplateError,
  ...
  AnalyzeOrphanedCustomerTabsData,
  AnalyzePosDependenciesData,
  AnalyzePosDesktopDependenciesData,
  ...
  ApplyCuratedMappingData,
  ApplyCuratedMappingError,
  ApplyMappingRequest,
  ApplyPromoCodeData,
  ApplyPromoCodeError,
  AssignItemsToTabData,
  AssignItemsToTabError,
  AssignItemsToTabRequest,
  AuditReportData,
  AuthSignupDiagnosticData,
  ...
  BodyUploadSingleImage,
  BulkCancelQueuedRunsData,
  BulkCancelQueuedRunsError,
  BulkCancelQueuedRunsParams,
  BulkDeleteItemsData,
  ...
  BulkUploadImagesData,
  BulkUploadImagesError,
  ...
  CreateOrderData,
  CreateOrderError,
  CreateOrderItemsTableData,
  CreatePaymentIntentData,
  CreatePaymentIntentError,
  CreatePaymentIntentRequest,
  CreatePosOrderData,
  CreatePosOrderError,
  CreatePosReleaseData,
  CreatePosReleaseError,
  CreatePosTableData,
  CreatePosTableError,
  CreatePrintJobData,
  CreatePrintJobError,
  ...
  GetAllAgentsData,
  GetAllDraftContentData,
  GetAllDraftContentError,
  GetAllDraftContentParams,
  ...
  GetCustomerTabData,
  GetCustomerTabError,
  GetCustomerTabItemsData,
  GetCustomerTabItemsError,
  GetCustomerTabItemsParams,
  GetCustomerTabParams,
  GetCustomerTotalCountData,
  ...
  GetDraftContentByPageData,
  GetDraftContentByPageError,
  GetDraftContentByPageParams,
  GetDraftLayoutData,
  GetDraftThemeData,
  ...
  GetEnrichedOrderItems2Data,
  GetEnrichedOrderItems2Error,
  GetEnrichedOrderItems2Params,
  GetEnrichedOrderItemsData,
  GetEnrichedOrderItemsError,
  GetEnrichedOrderItemsParams,
  GetFileShaData,
  GetFileShaError,
  GetFileShaParams,
  ...
  GetPublishedContentData,
  GetPublishedContentError,
  GetPublishedContentParams,
  GetPublishedLayoutData,
  GetPublishedThemeData,
  GetQueueStatusData,
  ...
  GetSyncJobStatusData,
  GetSyncJobStatusError,
  GetSyncJobStatusParams,
  ...
  GetUnpublishedChangesData,
  GetUnpublishedCountData,
  ...
  InitializeStorageTablesData,
  InitializeUnifiedAgentConfigData,
  InsertTestDataEndpointData,
  ...
  LogFrontendRenderData,
  LogFrontendRenderError,
  LogMessageData,
  LogMessageError,
  LogMessagePayload,
  LogSessionEndData,
  ...
  MergeTabsError,
  MergeTabsRequest,
  MigrateDropOrderItemsColumnData,
  MigrateFixTableStatusesData,
  MigrateProfilesToCustomersData,
  MigrateStaticAssetsData,
  MigrateStaticAssetsError,
  MigrateStaticAssetsParams,
  ...
  PublishLayoutChangesData,
  PublishLayoutChangesError,
  ...
  ResetCodeSystemData,
  ResetLayoutRequest,
  ResetLayoutToDefaultData,
  ResetLayoutToDefaultError,
  ...
  ResetThemeRequest,
  ResetThemeToDefaultData,
  ResetThemeToDefaultError,
  ...
  TestVoiceExecutorHealthCheckData,
  ThemeHealthCheckData,
  ...
  TrustDeviceRequest,
  UnassignItemsFromTabData,
  UnassignItemsFromTabError,
  UnassignItemsRequest,
  ...
  UpdateGuestCountCommand,
  UpdateGuestCountData,
  UpdateGuestCountError,
  UpdateItemCommand,
  ...
  UpdateItemQuantityDineInData,
  UpdateItemQuantityDineInError,
  UpdateLayoutRequest,
  UpdateLayoutSettingData,
  UpdateLayoutSettingError,
  ...
  UpdateMenuPrintSettingsData,
  UpdateMenuPrintSettingsError,
  UpdateMenuPrintSettingsPayload,
  UpdateOrderRequest,
  ...
  UpdateTableRequest,
  UpdateTextContentData,
  UpdateTextContentError,
  UpdateTextRequest,
  UpdateThemeRequest,
  UpdateThemeSettingData,
  UpdateThemeSettingError,
  ...
  VoiceSessionRequest,
  WebsiteCmsSchemaHealthCheckData,
  WebsiteContentMgmtHealthCheckData,
} from "./data-contracts";
...
export class Apiclient<SecurityDataType = unknown> extends HttpClient<SecurityDataType> {
   ...
   * @name get_customer_total_count
   * @summary Get Customer Total Count
   * @request GET:/routes/customer-stats/total-count
   */
  get_customer_total_count = (params: RequestParams = {}) =>
    this.request<GetCustomerTotalCountData, any>({
      path: `/routes/customer-stats/total-count`,
      method: "GET",
      ...params,
    });
   ...
   * @request POST:/routes/sql-execution/add-order-timing-fields
   */
  add_order_timing_fields = (params: RequestParams = {}) =>
    this.request<AddOrderTimingFieldsData, any>({
      path: `/routes/sql-execution/add-order-timing-fields`,
      method: "POST",
      ...params,
    });
   ...
   * @request GET:/routes/sql-execution/check-order-timing-fields
   */
  check_order_timing_fields = (params: RequestParams = {}) =>
    this.request<CheckOrderTimingFieldsData, any>({
      path: `/routes/sql-execution/check-order-timing-fields`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Cancel a specific workflow run. Args: run_id: The workflow run ID to cancel owner: Repository owner (default: Bodzaman) repo: Repository name (default: cottage-pos-desktop) Returns: Success status and message
   *
   * @tags dbtn/module:github_workflow_logs
   * @name cancel_workflow_run
   * @summary Cancel Workflow Run
   * @request POST:/routes/cancel-workflow-run/{run_id}
   */
  cancel_workflow_run = ({ runId, ...query }: CancelWorkflowRunParams, params: RequestParams = {}) =>
    this.request<CancelWorkflowRunData, CancelWorkflowRunError>({
      path: `/routes/cancel-workflow-run/${runId}`,
      method: "POST",
      query: query,
      ...params,
    });
  ...
  /**
   * @description Cancel all queued and in_progress workflow runs. Args: owner: Repository owner (default: Bodzaman) repo: Repository name (default: cottage-pos-desktop) workflow_file: Workflow file name (default: build-combined-installer.yml) max_runs: Maximum number of runs to fetch and cancel (default: 50) Returns: Summary of cancellation results
   *
   * @tags dbtn/module:github_workflow_logs
   * @name bulk_cancel_queued_runs
   * @summary Bulk Cancel Queued Runs
   * @request POST:/routes/bulk-cancel-queued-runs
   */
  bulk_cancel_queued_runs = (query: BulkCancelQueuedRunsParams, params: RequestParams = {}) =>
    this.request<BulkCancelQueuedRunsData, BulkCancelQueuedRunsError>({
      path: `/routes/bulk-cancel-queued-runs`,
      method: "POST",
      query: query,
      ...params,
    });
  ...
  /**
   * @description Endpoint to receive frontend rendering logs
   *
   * @tags dbtn/module:frontend_diagnostics
   * @name log_frontend_render
   * @summary Log Frontend Render
   * @request POST:/routes/log-frontend-render
   */
  log_frontend_render = (data: FrontendLogRequest, params: RequestParams = {}) =>
    this.request<LogFrontendRenderData, LogFrontendRenderError>({
      path: `/routes/log-frontend-render`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description ✅ RELATIONAL: Assign existing dine_in_order_items to a customer tab. Updates customer_tab_id foreign key instead of JSONB manipulation.
   *
   * @tags dbtn/module:customer_tabs
   * @name assign_items_to_tab
   * @summary Assign Items To Tab
   * @request POST:/routes/customer-tabs/assign-items-to-tab
   */
  assign_items_to_tab = (data: AssignItemsToTabRequest, params: RequestParams = {}) =>
    this.request<AssignItemsToTabData, AssignItemsToTabError>({
      path: `/routes/customer-tabs/assign-items-to-tab`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description ✅ RELATIONAL: Remove items from customer tab (set customer_tab_id = NULL). Items remain in order but not assigned to any specific guest.
   *
   * @tags dbtn/module:customer_tabs
   * @name unassign_items_from_tab
   * @summary Unassign Items From Tab
   * @request POST:/routes/customer-tabs/unassign-items-from-tab
   */
  unassign_items_from_tab = (data: UnassignItemsRequest, params: RequestParams = {}) =>
    this.request<UnassignItemsFromTabData, UnassignItemsFromTabError>({
      path: `/routes/customer-tabs/unassign-items-from-tab`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description ✅ RELATIONAL: Get all items assigned to a customer tab. Queries dine_in_order_items table via customer_tab_id foreign key.
   *
   * @tags dbtn/module:customer_tabs
   * @name get_customer_tab_items
   * @summary Get Customer Tab Items
   * @request GET:/routes/customer-tabs/tab/{tab_id}/items
   */
  get_customer_tab_items = ({ tabId, ...query }: GetCustomerTabItemsParams, params: RequestParams = {}) =>
    this.request<GetCustomerTabItemsData, GetCustomerTabItemsError>({
      path: `/routes/customer-tabs/tab/${tabId}/items`,
      method: "GET",
      ...params,
    });

  /**
   * @description 🔧 MIGRATION: Drop the deprecated order_items JSONB column from customer_tabs table. This is safe to run after relational migration is complete (MYA-1685). All items are now stored in dine_in_order_items table.
   *
   * @tags dbtn/module:customer_tabs
   * @name migrate_drop_order_items_column
   * @summary Migrate Drop Order Items Column
   * @request POST:/routes/customer-tabs/migrate-drop-order-items-column
   */
  migrate_drop_order_items_column = (params: RequestParams = {}) =>
    this.request<MigrateDropOrderItemsColumnData, any>({
      path: `/routes/customer-tabs/migrate-drop-order-items-column`,
      method: "POST",
      ...params,
    });
  ...
  /**
   * @description Update customer tab details (name, status)
   *
   * @tags dbtn/module:customer_tabs
  ...
  /**
   * @description Create the pos_desktop_files table in Supabase with proper schema. Returns: Setup result with details
   *
   * @tags dbtn/module:pos_curated_sync
   * @name setup_pos_desktop_files
   * @summary Setup Pos Desktop Files
   * @request POST:/routes/setup-pos-desktop-files
   */
  setup_pos_desktop_files = (params: RequestParams = {}) =>
    this.request<SetupPosDesktopFilesData, any>({
      path: `/routes/setup-pos-desktop-files`,
      method: "POST",
      ...params,
    });

  /**
   * @description Analyze curated file list from Supabase against current mapping. Returns: Analysis showing which files are mapped/unmapped, with breakdown by type
   *
   * @tags dbtn/module:pos_curated_sync
   * @name get_curated_analysis
   * @summary Get Curated Analysis
   * @request GET:/routes/curated-analysis
   */
  get_curated_analysis = (params: RequestParams = {}) =>
    this.request<GetCuratedAnalysisData, any>({
      path: `/routes/curated-analysis`,
      method: "GET",
      ...params,
    });

  /**
   * @description Apply unmapped files from Supabase to the file mapping. Args: request: List of files to add to mapping Returns: Result of mapping operation
   *
   * @tags dbtn/module:pos_curated_sync
   * @name apply_curated_mapping
   * @summary Apply Curated Mapping
   * @request POST:/routes/apply-curated-mapping
   */
  apply_curated_mapping = (data: ApplyMappingRequest, params: RequestParams = {}) =>
    this.request<ApplyCuratedMappingData, ApplyCuratedMappingError>({
      path: `/routes/apply-curated-mapping`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
   ...
   *
   * @tags dbtn/module:github_kds_manager
   * @name check_github_kds_health
   * @summary Check Github Kds Health
   * @request GET:/routes/github-kds-health
   */
  check_github_kds_health = (params: RequestParams = {}) =>
    this.request<CheckGithubKdsHealthData, any>({
      path: `/routes/github-kds-health`,
      method: "GET",
      ...params,
    });
   ...
   * @request GET:/routes/unified-menu-operations/items
   */
  get_menu_items = (params: RequestParams = {}) =>
    this.request<GetMenuItemsData, any>({
      path: `/routes/unified-menu-operations/items`,
      method: "GET",
      ...params,
    });
   ...
   * @request POST:/routes/unified-menu-operations/items
   */
   ...
   * @request PUT:/routes/unified-menu-operations/items/{item_id}
   */
  update_menu_item = ({ itemId, ...query }: UpdateMenuItemParams, data: MenuItemUpdate, params: RequestParams = {}) =>
    this.request<UpdateMenuItemData, UpdateMenuItemError>({
      path: `/routes/unified-menu-operations/items/${itemId}`,
      method: "PUT",
      body: data,
      type: ContentType.Json,
      ...params,
   ...
   * @request DELETE:/routes/unified-menu-operations/items/{item_id}
   */
   ...
   * @request POST:/routes/unified-menu-operations/bulk/delete
   */
  bulk_delete_items = (data: AppApisUnifiedMenuOperationsBulkDeleteRequest, params: RequestParams = {}) =>
    this.request<BulkDeleteItemsData, BulkDeleteItemsError>({
      path: `/routes/unified-menu-operations/bulk/delete`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
   ...
   * @request GET:/routes/unified-menu-operations/categories
   */
  get_categories = (params: RequestParams = {}) =>
    this.request<GetCategoriesData, any>({
      path: `/routes/unified-menu-operations/categories`,
      method: "GET",
      ...params,
    });
   ...
   * @request GET:/routes/unified-menu-operations/proteins
   */
  get_protein_types = (params: RequestParams = {}) =>
    this.request<GetProteinTypesData, any>({
      path: `/routes/unified-menu-operations/proteins`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Verify that all CMS tables, indexes, and views exist and are accessible. Returns: SchemaVerificationResponse with verification results
   *
   * @tags dbtn/module:website_cms_schema_verify
   * @name verify_cms_schema
   * @summary Verify Cms Schema
   * @request GET:/routes/website-cms-schema/verify
   */
  verify_cms_schema = (params: RequestParams = {}) =>
    this.request<VerifyCmsSchemaData, any>({
      path: `/routes/website-cms-schema/verify`,
      method: "GET",
      ...params,
    });

  /**
   * @description Insert test data into all CMS tables to verify schema functionality. Returns: TestDataResponse with insertion results
   *
   * @tags dbtn/module:website_cms_schema_verify
   * @name insert_test_data_endpoint
   * @summary Insert Test Data Endpoint
   * @request POST:/routes/website-cms-schema/test-insert
   */
  insert_test_data_endpoint = (params: RequestParams = {}) =>
    this.request<InsertTestDataEndpointData, any>({
      path: `/routes/website-cms-schema/test-insert`,
      method: "POST",
      ...params,
    });

  /**
   * @description Remove test data from all CMS tables. Returns: TestDataResponse with cleanup results
   *
   * @tags dbtn/module:website_cms_schema_verify
   * @name cleanup_test_data_endpoint
   * @summary Cleanup Test Data Endpoint
   * @request POST:/routes/website-cms-schema/test-cleanup
   */
  cleanup_test_data_endpoint = (params: RequestParams = {}) =>
    this.request<CleanupTestDataEndpointData, any>({
      path: `/routes/website-cms-schema/test-cleanup`,
      method: "POST",
      ...params,
    });

  /**
   * @description Get current row counts for all CMS tables. Returns: TableStatsResponse with table statistics
   *
   * @tags dbtn/module:website_cms_schema_verify
   * @name get_table_stats
   * @summary Get Table Stats
   * @request GET:/routes/website-cms-schema/stats
   */
  get_table_stats = (params: RequestParams = {}) =>
    this.request<GetTableStatsData, any>({
      path: `/routes/website-cms-schema/stats`,
      method: "GET",
      ...params,
    });

  /**
   * @description Simple health check for the CMS schema verification API. Returns: dict: Health status
   *
   * @tags dbtn/module:website_cms_schema_verify
   * @name website_cms_schema_health_check
   * @summary Website Cms Schema Health Check
   * @request GET:/routes/website-cms-schema/health
   */
  website_cms_schema_health_check = (params: RequestParams = {}) =>
    this.request<WebsiteCmsSchemaHealthCheckData, any>({
      path: `/routes/website-cms-schema/health`,
      method: "GET",
      ...params,
    });
   ...
   *
   * @tags dbtn/module:auth_signup_diagnostic
   * @name auth_signup_diagnostic
   * @summary Auth Signup Diagnostic
   * @request GET:/routes/auth-signup-diagnostic
   */
  auth_signup_diagnostic = (params: RequestParams = {}) =>
    this.request<AuthSignupDiagnosticData, any>({
      path: `/routes/auth-signup-diagnostic`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Get all draft content, optionally filtered by page, section, or content type. Results are grouped by section for easier admin UI rendering.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name get_all_draft_content
   * @summary Get All Draft Content
   * @request GET:/routes/website-content/draft/all
   */
  get_all_draft_content = (query: GetAllDraftContentParams, params: RequestParams = {}) =>
    this.request<GetAllDraftContentData, GetAllDraftContentError>({
      path: `/routes/website-content/draft/all`,
      method: "GET",
      query: query,
      ...params,
    });
  ...
  /**
   * @description Get all draft content for a specific page.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name get_draft_content_by_page
   * @summary Get Draft Content By Page
   * @request GET:/routes/website-content/draft/page/{page}
   */
  get_draft_content_by_page = ({ page, ...query }: GetDraftContentByPageParams, params: RequestParams = {}) =>
    this.request<GetDraftContentByPageData, GetDraftContentByPageError>({
      path: `/routes/website-content/draft/page/${page}`,
      method: "GET",
      ...params,
    });

  /**
   * @description Upload a single image for website content. Generates optimized variants (full, medium, thumbnail) in WebP and JPEG.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name upload_single_image
   * @summary Upload Single Image
   * @request POST:/routes/website-content/upload-image
   */
  upload_single_image = (data: BodyUploadSingleImage, params: RequestParams = {}) =>
    this.request<UploadSingleImageData, UploadSingleImageError>({
      path: `/routes/website-content/upload-image`,
      method: "POST",
      body: data,
      type: ContentType.FormData,
      ...params,
  ...
  /**
   * @description Bulk upload multiple images for website content. Automatically assigns sequential display_order and labels.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name bulk_upload_images
   * @summary Bulk Upload Images
   * @request POST:/routes/website-content/bulk-upload
   */
  bulk_upload_images = (data: BodyBulkUploadImages, params: RequestParams = {}) =>
    this.request<BulkUploadImagesData, BulkUploadImagesError>({
      path: `/routes/website-content/bulk-upload`,
      method: "POST",
      body: data,
      type: ContentType.FormData,
      ...params,
  ...
  /**
   * @description Update text or rich_text content in draft state.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name update_text_content
   * @summary Update Text Content
   * @request PUT:/routes/website-content/update-text
   */
  update_text_content = (data: UpdateTextRequest, params: RequestParams = {}) =>
    this.request<UpdateTextContentData, UpdateTextContentError>({
      path: `/routes/website-content/update-text`,
      method: "PUT",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Create a new text, rich_text, or heading content block.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name create_text_block
   * @summary Create Text Block
   * @request POST:/routes/website-content/create-text-block
   */
  create_text_block = (data: CreateTextBlockPayload, params: RequestParams = {}) =>
    this.request<CreateTextBlockData, CreateTextBlockError>({
      path: `/routes/website-content/create-text-block`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Update display order for multiple content items (drag-reorder).
   *
   * @tags dbtn/module:website_content_mgmt
   * @name update_display_order
   * @summary Update Display Order
   * @request PUT:/routes/website-content/update-order
   */
  update_display_order = (data: UpdateOrderRequest, params: RequestParams = {}) =>
    this.request<UpdateDisplayOrderData, UpdateDisplayOrderError>({
      path: `/routes/website-content/update-order`,
      method: "PUT",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Delete a content item permanently.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name delete_content
   * @summary Delete Content
   * @request DELETE:/routes/website-content/delete/{content_key}
   */
  delete_content = ({ contentKey, ...query }: DeleteContentParams, params: RequestParams = {}) =>
    this.request<DeleteContentData, DeleteContentError>({
      path: `/routes/website-content/delete/${contentKey}`,
      method: "DELETE",
      ...params,
    });

  /**
   * @description Get published content for a specific page. This endpoint is used by public pages to load content.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name get_published_content
   * @summary Get Published Content
   * @request GET:/routes/website-content/published/{page}
   */
  get_published_content = ({ page, ...query }: GetPublishedContentParams, params: RequestParams = {}) =>
    this.request<GetPublishedContentData, GetPublishedContentError>({
      path: `/routes/website-content/published/${page}`,
      method: "GET",
      query: query,
      ...params,
    });
  ...
  /**
   * @description Publish content items. If content_keys is provided, publish only those items. If content_keys is None, publish ALL items with unpublished changes.
   *
   * @tags dbtn/module:website_content_mgmt
   * @name publish_content
   * @summary Publish Content
   * @request POST:/routes/website-content/publish
   */
  publish_content = (data: PublishRequest, params: RequestParams = {}) =>
    this.request<PublishContentData, PublishContentError>({
      path: `/routes/website-content/publish`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
   ...
   *
   * @tags dbtn/module:website_content_mgmt
   * @name website_content_mgmt_health_check
   * @summary Website Content Mgmt Health Check
   * @request GET:/routes/website-content/health
   */
  website_content_mgmt_health_check = (params: RequestParams = {}) =>
    this.request<WebsiteContentMgmtHealthCheckData, any>({
      path: `/routes/website-content/health`,
      method: "GET",
      ...params,
    });
   ...
   * @request POST:/routes/view-menu-items-with-variants
   */
  ...
  /**
   * @description Get enriched dine-in order items with full menu metadata. JOINs dine_in_order_items with: - menu_items (descriptions, pricing, dietary info) - menu_categories (category names) - media_assets (image URLs) - menu_item_variants (variant-specific data) - menu_protein_types (protein names) Used by DineInFullReviewModal for rich visual display.
   *
   * @tags dbtn/module:dine_in_enriched
   * @name get_enriched_order_items
   * @summary Get Enriched Order Items
   * @request GET:/routes/dine-in-enriched/orders/{order_id}/enriched-items
   */
  get_enriched_order_items = ({ orderId, ...query }: GetEnrichedOrderItemsParams, params: RequestParams = {}) =>
    this.request<GetEnrichedOrderItemsData, GetEnrichedOrderItemsError>({
      path: `/routes/dine-in-enriched/orders/${orderId}/enriched-items`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Get signature dishes from AdminMenu database. Filters menu items marked as 'signature' or featured. NOTE: Returns empty array until 'is_signature' column is added to menu_items table.
   *
   ...
   */
  get_signature_dishes = (params: RequestParams = {}) =>
    this.request<GetSignatureDishesData, any>({
  ...
  /**
   * @description Get current draft theme configuration for editing.
   *
   * @tags dbtn/module:website_theme_mgmt
   * @name get_draft_theme
   * @summary Get Draft Theme
   * @request GET:/routes/website-theme/draft
   */
  get_draft_theme = (params: RequestParams = {}) =>
    this.request<GetDraftThemeData, any>({
      path: `/routes/website-theme/draft`,
      method: "GET",
      ...params,
    });

  /**
   * @description Update a single theme setting in draft.
   *
   * @tags dbtn/module:website_theme_mgmt
   * @name update_theme_setting
   * @summary Update Theme Setting
   * @request PUT:/routes/website-theme/update
   */
  update_theme_setting = (data: UpdateThemeRequest, params: RequestParams = {}) =>
    this.request<UpdateThemeSettingData, UpdateThemeSettingError>({
      path: `/routes/website-theme/update`,
      method: "PUT",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Reset all theme settings to default Cottage Tandoori theme.
   *
   * @tags dbtn/module:website_theme_mgmt
   * @name reset_theme_to_default
   * @summary Reset Theme To Default
   * @request POST:/routes/website-theme/reset
   */
  reset_theme_to_default = (data: ResetThemeRequest, params: RequestParams = {}) =>
    this.request<ResetThemeToDefaultData, ResetThemeToDefaultError>({
      path: `/routes/website-theme/reset`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Get published theme configuration for public website.
   *
   * @tags dbtn/module:website_theme_mgmt
   * @name get_published_theme
   * @summary Get Published Theme
   * @request GET:/routes/website-theme/published
   */
  get_published_theme = (params: RequestParams = {}) =>
    this.request<GetPublishedThemeData, any>({
      path: `/routes/website-theme/published`,
      method: "GET",
      ...params,
    });

  /**
   * @description Publish all theme changes (copy draft to published).
   *
   * @tags dbtn/module:website_theme_mgmt
   * @name publish_theme
   * @summary Publish Theme
   * @request POST:/routes/website-theme/publish
   */
  publish_theme = (params: RequestParams = {}) =>
    this.request<PublishThemeData, any>({
      path: `/routes/website-theme/publish`,
      method: "POST",
      ...params,
    });
   ...
   *
   * @tags dbtn/module:website_theme_mgmt
   * @name theme_health_check
   * @summary Theme Health Check
   * @request GET:/routes/website-theme/health
   */
  theme_health_check = (params: RequestParams = {}) =>
    this.request<ThemeHealthCheckData, any>({
      path: `/routes/website-theme/health`,
      method: "GET",
      ...params,
    });

  /**
   * @description Initialize Riff storage tables in Supabase Creates: - riff_json_storage table with TTL support - Indexes for performance - RLS policies (disabled for backend-only access) Safe to run multiple times (idempotent)
   *
   * @tags dbtn/module:riff_storage_setup
   * @name initialize_storage_tables
   * @summary Initialize Storage Tables
   * @request POST:/routes/riff-storage-setup/initialize
   */
  initialize_storage_tables = (params: RequestParams = {}) =>
    this.request<InitializeStorageTablesData, any>({
      path: `/routes/riff-storage-setup/initialize`,
      method: "POST",
      ...params,
    });

  /**
   * @description Get statistics about current storage usage Returns: - Total items stored - Breakdown by namespace - Count of expired items - Estimated total size
   *
   * @tags dbtn/module:riff_storage_setup
   * @name get_storage_stats
   * @summary Get Storage Stats
   * @request GET:/routes/riff-storage-setup/stats
   */
  get_storage_stats = (params: RequestParams = {}) =>
    this.request<GetStorageStatsData, any>({
      path: `/routes/riff-storage-setup/stats`,
      method: "GET",
      ...params,
    });

  /**
   * @description Clean up expired items from storage Removes all items where expires_at < NOW() Returns: - Count of items removed - Namespaces affected
   *
   * @tags dbtn/module:riff_storage_setup
   * @name cleanup_expired_items
   * @summary Cleanup Expired Items
   * @request POST:/routes/riff-storage-setup/cleanup-expired
   */
  cleanup_expired_items = (params: RequestParams = {}) =>
    this.request<CleanupExpiredItemsData, any>({
      path: `/routes/riff-storage-setup/cleanup-expired`,
      method: "POST",
      ...params,
    });

  /**
   * @description Health check for storage system Verifies: - Table exists - Can read/write - Indexes are present
   *
   * @tags dbtn/module:riff_storage_setup
   * @name check_storage_health
   * @summary Check Storage Health
   * @request GET:/routes/riff-storage-setup/health
   */
  check_storage_health = (params: RequestParams = {}) =>
    this.request<CheckStorageHealthData, any>({
      path: `/routes/riff-storage-setup/health`,
      method: "GET",
      ...params,
    });

  /**
   * @description List all namespaces in storage Returns: - Distinct namespaces - Count per namespace - Sample keys from each namespace
   *
   * @tags dbtn/module:riff_storage_setup
   * @name list_namespaces
   * @summary List Namespaces
   * @request GET:/routes/riff-storage-setup/namespaces
   */
  list_namespaces = (params: RequestParams = {}) =>
    this.request<ListNamespacesData, any>({
      path: `/routes/riff-storage-setup/namespaces`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Main endpoint to update POS Desktop code and create GitHub release This endpoint: 1. Syncs curated POS files to GitHub (all in one commit) 2. Creates GitHub release (triggers build workflow) 3. Returns release info and workflow URL
   *
   * @tags dbtn/module:update_pos_desktop
  ...
  /**
   * @description Create GitHub release for POS Desktop after sync completes This endpoint is called by the frontend after async file sync completes. It creates the GitHub release tag which triggers the build workflow.
   *
   * @tags dbtn/module:update_pos_desktop
   * @name create_pos_release
   * @summary Create Pos Release
   * @request POST:/routes/create-pos-release
   */
  create_pos_release = (data: UpdatePOSDesktopRequest, params: RequestParams = {}) =>
    this.request<CreatePosReleaseData, CreatePosReleaseError>({
      path: `/routes/create-pos-release`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Start async sync of POS Desktop files - returns immediately with job ID
   *
   * @tags dbtn/module:update_pos_desktop
   * @name sync_pos_files
   ...
   *
   * @tags dbtn/module:update_pos_desktop
   * @name get_sync_job_status
   * @summary Get Sync Job Status
   * @request GET:/routes/sync-job-status/{job_id}
   */
  get_sync_job_status = ({ jobId, ...query }: GetSyncJobStatusParams, params: RequestParams = {}) =>
    this.request<GetSyncJobStatusData, GetSyncJobStatusError>({
      path: `/routes/sync-job-status/${jobId}`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Sync electron-builder configuration to GitHub. This replaces the custom NSIS installer approach with native electron-builder. Returns: Sync status with GitHub URLs
   *
   * @tags dbtn/module:update_pos_desktop
  ...
  /**
   * @description Recursively analyze POSDesktop.tsx and ALL its dependencies to find the complete dependency tree and compare against current file_mapping. This prevents partial syncs by discovering transitive dependencies. For example: POSDesktop -> DineInOrderModal -> customerTabAdapters Returns: Complete analysis report with all mapped and unmapped files
   *
   * @tags dbtn/module:update_pos_desktop
  ...
  /**
   * @description Get a specific receipt template by ID or name Templates are shared resources designed once and used across all staff. No authentication required for display purposes. Args: template_id: Template ID (UUID) or template name user_id: Optional user ID (deprecated, kept for backward compatibility) Returns: Template data wrapped in success response
   *
   * @tags dbtn/module:receipt_templates
  ...
  /**
   * @description Get current draft layout configuration for editing.
   *
   * @tags dbtn/module:website_layout_mgmt
   * @name get_draft_layout
   * @summary Get Draft Layout
   * @request GET:/routes/website-layout/draft
   */
  get_draft_layout = (params: RequestParams = {}) =>
    this.request<GetDraftLayoutData, any>({
      path: `/routes/website-layout/draft`,
      method: "GET",
      ...params,
    });

  /**
   * @description Update a single layout setting in draft.
   *
   * @tags dbtn/module:website_layout_mgmt
   * @name update_layout_setting
   * @summary Update Layout Setting
   * @request PUT:/routes/website-layout/update
   */
  update_layout_setting = (data: UpdateLayoutRequest, params: RequestParams = {}) =>
    this.request<UpdateLayoutSettingData, UpdateLayoutSettingError>({
      path: `/routes/website-layout/update`,
      method: "PUT",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Reset layout settings to default configuration.
   *
   * @tags dbtn/module:website_layout_mgmt
   * @name reset_layout_to_default
   * @summary Reset Layout To Default
   * @request POST:/routes/website-layout/reset
   */
  reset_layout_to_default = (data: ResetLayoutRequest, params: RequestParams = {}) =>
    this.request<ResetLayoutToDefaultData, ResetLayoutToDefaultError>({
      path: `/routes/website-layout/reset`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Get published layout configuration for public website.
   *
   * @tags dbtn/module:website_layout_mgmt
   * @name get_published_layout
   * @summary Get Published Layout
   * @request GET:/routes/website-layout/published
   */
  get_published_layout = (params: RequestParams = {}) =>
    this.request<GetPublishedLayoutData, any>({
      path: `/routes/website-layout/published`,
      method: "GET",
      ...params,
    });

  /**
   * @description Publish all draft layout changes to make them live.
   *
   * @tags dbtn/module:website_layout_mgmt
   * @name publish_layout_changes
   * @summary Publish Layout Changes
   * @request POST:/routes/website-layout/publish
   */
  publish_layout_changes = (data: PublishLayoutRequest, params: RequestParams = {}) =>
    this.request<PublishLayoutChangesData, PublishLayoutChangesError>({
      path: `/routes/website-layout/publish`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Health check for layout management system.
   *
   * @tags dbtn/module:website_layout_mgmt
   * @name layout_health_check
   * @summary Layout Health Check
   * @request GET:/routes/website-layout/health
   */
  layout_health_check = (params: RequestParams = {}) =>
    this.request<LayoutHealthCheckData, any>({
      path: `/routes/website-layout/health`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Complete table order (final bill paid, table becomes available) This endpoint handles management delete/reset action: 1. Updates pos_tables.status → AVAILABLE (makes table green) 2. Updates orders.status → COMPLETED (closes the order) 3. Real-time subscriptions pick up changes automatically
   *
   * @tags dbtn/module:table_orders
  ...
  /**
   * @description Get count of all unpublished changes. Returns total count plus breakdown by table (content, theme, layout). Used for top bar badge in CMS.
   *
   * @tags website_cms_publish, dbtn/module:website_cms_publish
   * @name get_unpublished_count
   * @summary Get Unpublished Count
   * @request GET:/routes/website-cms/unpublished-count
   */
  get_unpublished_count = (params: RequestParams = {}) =>
    this.request<GetUnpublishedCountData, any>({
      path: `/routes/website-cms/unpublished-count`,
      method: "GET",
      ...params,
    });

  /**
   * @description Get detailed list of all unpublished changes. Uses the website_unpublished_changes view to get unified list across content, theme, and layout tables. Returns: - List of all changes with metadata - Count grouped by page - Count grouped by change type
   *
   * @tags website_cms_publish, dbtn/module:website_cms_publish
   * @name get_unpublished_changes
   * @summary Get Unpublished Changes
   * @request GET:/routes/website-cms/unpublished-changes
   */
  get_unpublished_changes = (params: RequestParams = {}) =>
    this.request<GetUnpublishedChangesData, any>({
      path: `/routes/website-cms/unpublished-changes`,
      method: "GET",
      ...params,
    });

  /**
   * @description Publish all unpublished changes atomically. Publishes changes across all 3 tables: - website_content: Copy draft → published - website_theme: Copy draft → published - website_layout: Copy draft → published For each item: 1. Copy draft fields to published fields 2. Set has_unpublished_changes = FALSE 3. Update last_published_at timestamp Returns count of items published per table.
   *
   * @tags website_cms_publish, dbtn/module:website_cms_publish
   * @name publish_all
   * @summary Publish All
   * @request POST:/routes/website-cms/publish-all
   */
  publish_all = (data: PublishAllRequest, params: RequestParams = {}) =>
    this.request<PublishAllData, PublishAllError>({
      path: `/routes/website-cms/publish-all`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Discard all draft changes atomically. Reverts all draft changes back to published state: - website_content: Copy published → draft - website_theme: Copy published → draft - website_layout: Copy published → draft For each item: 1. Copy published fields to draft fields 2. Set has_unpublished_changes = FALSE WARNING: This cannot be undone! Returns count of items discarded per table.
   *
   * @tags website_cms_publish, dbtn/module:website_cms_publish
   * @name discard_all
   * @summary Discard All
   * @request POST:/routes/website-cms/discard-all
   */
  discard_all = (data: DiscardAllRequest, params: RequestParams = {}) =>
    this.request<DiscardAllData, DiscardAllError>({
      path: `/routes/website-cms/discard-all`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
   ...
   * @request GET:/routes/website-cms/health
   */
  health_check = (params: RequestParams = {}) =>
    this.request<HealthCheckData, any>({
      path: `/routes/website-cms/health`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Analyze customer_tabs to identify orphaned entries. Does NOT delete anything - just reports what would be cleaned.
   *
   * @tags dbtn/module:cleanup_orphaned_customer_tabs
   * @name analyze_orphaned_customer_tabs
   * @summary Analyze Orphaned Customer Tabs
   * @request GET:/routes/analyze-orphaned-tabs
   */
  analyze_orphaned_customer_tabs = (params: RequestParams = {}) =>
    this.request<AnalyzeOrphanedCustomerTabsData, any>({
      path: `/routes/analyze-orphaned-tabs`,
      method: "GET",
      ...params,
    });

  /**
   * @description DELETE orphaned customer tabs. Removes tabs that reference non-existent, closed, or mismatched orders.
   *
   * @tags dbtn/module:cleanup_orphaned_customer_tabs
   * @name cleanup_orphaned_customer_tabs
   * @summary Cleanup Orphaned Customer Tabs
   * @request POST:/routes/cleanup-orphaned-tabs
   */
  cleanup_orphaned_customer_tabs = (params: RequestParams = {}) =>
    this.request<CleanupOrphanedCustomerTabsData, any>({
      path: `/routes/cleanup-orphaned-tabs`,
      method: "POST",
      ...params,
    });
  ...
  /**
   * @description Sync menu corpus data for voice AI agent
   *
   * @tags menu-corpus, dbtn/module:menu_corpus
  ...
  /**
   * @description Debug endpoint for voice AI agents - no authentication required
   *
   * @tags menu-corpus, dbtn/module:menu_corpus
  ...
  /**
   * @description Check the health of the menu corpus system
   *
   * @tags menu-corpus, dbtn/module:menu_corpus
  ...
  /**
   * @description Publish draft menu items to live status
   *
  ...
  /**
   * @description Get detailed menu status including draft vs published item counts
   *
   * @tags menu-publish, dbtn/module:menu_corpus
  ...
  /**
   * @description Optimize and resize images for faster loading. Returns optimized image with proper Content-Type headers. Caches resized images in riff_storage for subsequent requests. Examples: - /optimized-image?url=https://example.com/image.jpg&w=400&h=400&format=webp - /optimized-image?url=https://example.com/image.jpg&w=80&h=80&format=jpeg&quality=90
   *
   ...
   * @summary Structured Chat
   * @request POST:/routes/structured-chat
   */
  structured_chat = (data: StructuredChatRequest, params: RequestParams = {}) =>
    this.request<StructuredChatData, StructuredChatError>({
  ...
  /**
   * @description Auto-confirm email for a user after signup. This endpoint automatically confirms a user's email address, allowing users to have an active session immediately after signup. Critical for smooth onboarding flow.
   *
   ...
   */
  update_cart_item_quantity = (data: UpdateQuantityRequest, params: RequestParams = {}) =>
    this.request<UpdateCartItemQuantityData, UpdateCartItemQuantityError>({
  ...
  /**
   * @description Migrate all 19 static assets from static.riff.new to Supabase Storage + database. Args: dry_run: If True, only check access without uploading asset_filter: Optional filter by content_key prefix (e.g., "home_" or "dishes_") Returns: MigrationResult with success status and detailed results
   *
   * @tags dbtn/module:website_cms_migration
   * @name migrate_static_assets
   * @summary Migrate Static Assets
   * @request POST:/routes/migrate-static-assets
   */
  migrate_static_assets = (query: MigrateStaticAssetsParams, params: RequestParams = {}) =>
    this.request<MigrateStaticAssetsData, MigrateStaticAssetsError>({
      path: `/routes/migrate-static-assets`,
      method: "POST",
      query: query,
      ...params,
    });
  ...
  /**
   * @description Verify all migrated assets are accessible and properly stored. Returns: Verification report with accessibility status for each asset
   *
   * @tags dbtn/module:website_cms_migration
   * @name verify_migrated_assets
   * @summary Verify Migrated Assets
   * @request GET:/routes/verify-migrated-assets
   */
  verify_migrated_assets = (params: RequestParams = {}) =>
    this.request<VerifyMigratedAssetsData, any>({
      path: `/routes/verify-migrated-assets`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Analyze POSDesktop.tsx and recursively trace ALL dependencies. Returns: - Complete file dependency tree - List of npm packages actually used - List of shadcn components actually used - List of missing files - Summary statistics
   *
   * @tags dbtn/module:pos_dependency_analyzer
   * @name analyze_pos_desktop_dependencies
   * @summary Analyze Pos Desktop Dependencies
   * @request POST:/routes/analyze-pos-desktop-dependencies
   */
  analyze_pos_desktop_dependencies = (params: RequestParams = {}) =>
    this.request<AnalyzePosDesktopDependenciesData, any>({
      path: `/routes/analyze-pos-desktop-dependencies`,
      method: "POST",
      ...params,
    });

  /**
   * @description Compare npm packages between Databutton's package.json and what we'd get from analyzing POSDesktop dependencies. Returns: - Databutton packages - Packages actually needed by POS Desktop - Packages missing in analysis - Unnecessary packages (bloat)
   *
   * @tags dbtn/module:pos_dependency_analyzer
   * @name compare_npm_packages
   * @summary Compare Npm Packages
   * @request POST:/routes/compare-npm-packages
   */
  compare_npm_packages = (params: RequestParams = {}) =>
    this.request<CompareNpmPackagesData, any>({
      path: `/routes/compare-npm-packages`,
      method: "POST",
      ...params,
    });
   ...
   *
   * @tags dbtn/module:unified_printing_system
   * @name get_print_templates
   * @summary Get Print Templates
   * @request GET:/routes/unified-printing/templates
   */
  get_print_templates = (params: RequestParams = {}) =>
    this.request<GetPrintTemplatesData, any>({
      path: `/routes/unified-printing/templates`,
      method: "GET",
      ...params,
    });

  /**
   * @description Add new print template
   *
   * @tags dbtn/module:unified_printing_system
   * @name add_print_template
   * @summary Add Print Template
   * @request POST:/routes/unified-printing/templates
   */
  add_print_template = (data: PrintTemplate, params: RequestParams = {}) =>
    this.request<AddPrintTemplateData, AddPrintTemplateError>({
      path: `/routes/unified-printing/templates`,
      method: "POST",
      body: data,
      type: ContentType.Json,
  ...
  /**
   * @description Get all print jobs with filters
   *
   * @tags dbtn/module:unified_printing_system
   * @name get_all_print_jobs
   * @summary Get All Print Jobs
   * @request GET:/routes/unified-printing/jobs
   */
  get_all_print_jobs = (params: RequestParams = {}) =>
    this.request<GetAllPrintJobsData, any>({
      path: `/routes/unified-printing/jobs`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Get menu print settings
   *
   * @tags dbtn/module:unified_printing_system
  ...
  /**
   * @description Update menu print settings
   *
   * @tags dbtn/module:unified_printing_system
   * @name update_menu_print_settings
   * @summary Update Menu Print Settings
   * @request POST:/routes/unified-printing/settings/menu-print
   */
  update_menu_print_settings = (data: UpdateMenuPrintSettingsPayload, params: RequestParams = {}) =>
    this.request<UpdateMenuPrintSettingsData, UpdateMenuPrintSettingsError>({
      path: `/routes/unified-printing/settings/menu-print`,
      method: "POST",
      body: data,
      type: ContentType.Json,
  ...
  /**
   * @description Diagnostic endpoint to verify execute_sql RPC function works. Tests: 1. RPC function exists 2. Simple SELECT query works 3. Simple CREATE TABLE test (creates/drops test_rpc_diagnostic table) 4. Foreign key constraint test
   *
   * @tags dbtn/module:dine_in_migration
   * @name diagnose_execute_sql_rpc
   * @summary Diagnose Execute Sql Rpc
   * @request GET:/routes/diagnose-execute-sql-rpc
   */
  diagnose_execute_sql_rpc = (params: RequestParams = {}) =>
    this.request<DiagnoseExecuteSqlRpcData, any>({
      path: `/routes/diagnose-execute-sql-rpc`,
      method: "GET",
      ...params,
    });

  /**
   * @description MYA-1686: Create clean dine_in_order_items table for DINE-IN orders. This is SEPARATE from existing order_items (used for TAKEAWAY/COLLECTION/DELIVERY). Schema designed specifically for dine-in workflow: - No client_id (walk-ins, not customer accounts) - table_number for table-based ordering - customer_tab_id for split bills - Kitchen status tracking (NEW → COOKING → READY → SERVED)
   *
   * @tags dbtn/module:dine_in_migration
   * @name create_order_items_table
   * @summary Create Order Items Table
   * @request POST:/routes/create-order-items-table
   */
  create_order_items_table = (params: RequestParams = {}) =>
    this.request<CreateOrderItemsTableData, any>({
      path: `/routes/create-order-items-table`,
      method: "POST",
      ...params,
    });

  /**
   * @description Test and validate order_items table schema. Checks: - Table exists - Indexes created - Triggers exist - RLS policies configured - Sample INSERT/SELECT/UPDATE/DELETE works - Foreign key constraints enforced
   *
   * @tags dbtn/module:dine_in_migration
   * @name test_order_items_schema
   * @summary Test Order Items Schema
   * @request GET:/routes/test-order-items-schema
   */
  test_order_items_schema = (params: RequestParams = {}) =>
    this.request<TestOrderItemsSchemaData, any>({
      path: `/routes/test-order-items-schema`,
      method: "GET",
      ...params,
    });

  /**
   * @description Quick health check for order_items table. Returns: - Table exists: bool - Row count: int - Items with NULL table_number: int (should be 0) - Status distribution: Dict[str, int]
   *
   * @tags dbtn/module:dine_in_migration
   * @name check_order_items_health
   * @summary Check Order Items Health
   * @request GET:/routes/check-order-items-health
   */
  check_order_items_health = (params: RequestParams = {}) =>
    this.request<CheckOrderItemsHealthData, any>({
      path: `/routes/check-order-items-health`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description Command: Create new dine-in order - ✅ PHASE 3: Checks for existing CREATED order first (prevents duplicates) - Creates order in CREATED state only if none exists - Links to table - Updates table status to OCCUPIED - Logs ORDER_CREATED event - ✅ NEW: Supports linked_tables for multi-table orders
   *
   * @tags dbtn/module:dine_in_commands
   * @name create_order
   * @summary Create Order
   * @request POST:/routes/dine-in-commands/create-order
   */
  create_order = (data: CreateOrderCommand, params: RequestParams = {}) =>
    this.request<CreateOrderData, CreateOrderError>({
      path: `/routes/dine-in-commands/create-order`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Add item to DINE-IN order (RELATIONAL) - Validates order is editable (CREATED or SENT_TO_KITCHEN states) - INSERTs new row into dine_in_order_items table (clean schema) - Enriches item with menu_item_id, category_id from database - Recalculates totals by querying dine_in_order_items - Updates order totals - Logs ITEM_ADDED event
   *
   * @tags dbtn/module:dine_in_commands
   * @name add_item_to_order
   * @summary Add Item To Order
   * @request POST:/routes/dine-in-commands/add-item
   */
  add_item_to_order = (data: AddItemCommand, params: RequestParams = {}) =>
    this.request<AddItemToOrderData, AddItemToOrderError>({
      path: `/routes/dine-in-commands/add-item`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Remove item from DINE-IN order (RELATIONAL) - Validates order is editable (CREATED or SENT_TO_KITCHEN states) - DELETEs row from dine_in_order_items table - Recalculates totals from remaining items - Auto-cancels order if no items remain - Logs ITEM_REMOVED event
   *
   * @tags dbtn/module:dine_in_commands
   * @name remove_item_from_order
   * @summary Remove Item From Order
   * @request POST:/routes/dine-in-commands/remove-item
   */
  remove_item_from_order = (data: RemoveItemCommand, params: RequestParams = {}) =>
    this.request<RemoveItemFromOrderData, RemoveItemFromOrderError>({
      path: `/routes/dine-in-commands/remove-item`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Update item quantity in DINE-IN order (RELATIONAL) - Validates order is editable (CREATED or SENT_TO_KITCHEN) - Updates item quantity in dine_in_order_items table - Recalculates order totals from dine_in_order_items - Logs ITEM_UPDATED event
   *
   * @tags dbtn/module:dine_in_commands
   * @name update_item_quantity_dine_in
   * @summary Update Item Quantity
   * @request POST:/routes/dine-in-commands/update-item-quantity
   */
  update_item_quantity_dine_in = (data: UpdateItemQuantityCommand, params: RequestParams = {}) =>
    this.request<UpdateItemQuantityDineInData, UpdateItemQuantityDineInError>({
      path: `/routes/dine-in-commands/update-item-quantity`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Update item customizations, notes, and/or quantity - Validates order is editable (CREATED or SENT_TO_KITCHEN states) - Updates item by ID with new customizations, notes, quantity - Recalculates item price based on customizations - Recalculates order totals - Logs ITEM_UPDATED event
   *
   * @tags dbtn/module:dine_in_commands
   * @name update_item
   * @summary Update Item
   * @request POST:/routes/dine-in-commands/update-item
   */
  update_item = (data: UpdateItemCommand, params: RequestParams = {}) =>
    this.request<UpdateItemData, UpdateItemError>({
      path: `/routes/dine-in-commands/update-item`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Send order to kitchen (RELATIONAL ARCHITECTURE) - Queries NEW items from dine_in_order_items table (status='NEW') - UPDATEs their status to 'SENT_TO_KITCHEN' with timestamp - Updates order status to SENT_TO_KITCHEN - Updates table status to OCCUPIED - Creates print queue job for kitchen ticket (only unsent items) - Supports re-sending orders with newly added items - Returns success with print job ID
   *
   * @tags dbtn/module:dine_in_commands
   * @name send_to_kitchen
   * @summary Send To Kitchen
   * @request POST:/routes/dine-in-commands/send-to-kitchen
   */
  send_to_kitchen = (data: SendToKitchenCommand, params: RequestParams = {}) =>
    this.request<SendToKitchenData, SendToKitchenError>({
      path: `/routes/dine-in-commands/send-to-kitchen`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Finalize DINE-IN order after payment (RELATIONAL ARCHITECTURE) - Validates order is ready for finalization (CREATED, SENT_TO_KITCHEN, or SERVED) - Marks all items as SERVED (item-level status tracking) - Updates order status to COMPLETED - Records payment details (method, amount, reference) - Clears table status to AVAILABLE - Returns finalized order summary NOTE: This does NOT handle payment processing (Adyen POS does that externally). This endpoint is called AFTER payment succeeds to update order state.
   *
   * @tags dbtn/module:dine_in_commands
   * @name finalize_order
   * @summary Finalize Order
   * @request POST:/routes/dine-in-commands/finalize-order
   */
  finalize_order = (data: FinalizeOrderCommand, params: RequestParams = {}) =>
    this.request<FinalizeOrderData, FinalizeOrderError>({
      path: `/routes/dine-in-commands/finalize-order`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Print bill for DINE-IN order - Creates print queue job for thermal receipt - Does NOT change order status (payment is external) - Returns print job ID for tracking This is the PROPER endpoint for DINE-IN bill printing. Unlike request-check (for Takeaway), this does NOT transition to PENDING_PAYMENT.
   *
   * @tags dbtn/module:dine_in_commands
   * @name print_dine_in_bill
   * @summary Print Dine In Bill
   * @request POST:/routes/dine-in-commands/print-dine-in-bill
   */
  print_dine_in_bill = (data: RequestCheckCommand, params: RequestParams = {}) =>
    this.request<PrintDineInBillData, PrintDineInBillError>({
      path: `/routes/dine-in-commands/print-dine-in-bill`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Customer requests bill - Transitions to PENDING_PAYMENT - Updates table status to REQUESTING_CHECK - Returns success (print job creation handled separately)
   *
   * @tags dbtn/module:dine_in_commands
   * @name request_check
   * @summary Request Check
   * @request POST:/routes/dine-in-commands/request-check
   */
  request_check = (data: RequestCheckCommand, params: RequestParams = {}) =>
    this.request<RequestCheckData, RequestCheckError>({
      path: `/routes/dine-in-commands/request-check`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Mark order as paid - Validates payment amount matches total - Transitions to PAID then CLOSED - Clears table (sets to AVAILABLE)
   *
   * @tags dbtn/module:dine_in_commands
   * @name mark_paid
   * @summary Mark Paid
   * @request POST:/routes/dine-in-commands/mark-paid
   */
  mark_paid = (data: MarkPaidCommand, params: RequestParams = {}) =>
    this.request<MarkPaidData, MarkPaidError>({
      path: `/routes/dine-in-commands/mark-paid`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Cancel order - Validates order is in any state - Transitions to ABANDONED status - Clears table (sets to AVAILABLE) - Returns success
   *
   * @tags dbtn/module:dine_in_commands
   * @name cancel_order
   * @summary Cancel Order
   * @request POST:/routes/dine-in-commands/cancel-order
   */
  cancel_order = (data: CancelOrderCommand, params: RequestParams = {}) =>
    this.request<CancelOrderData, CancelOrderError>({
      path: `/routes/dine-in-commands/cancel-order`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Update guest count for an order - Can be updated at any time during service (not restricted by order status) - Validates guest_count >= 1 - Logs GUEST_COUNT_UPDATED event to state history - Returns updated order with new guest count
   *
   * @tags dbtn/module:dine_in_commands
   * @name update_guest_count
   * @summary Update Guest Count
   * @request POST:/routes/dine-in-commands/update-guest-count
   */
  update_guest_count = (data: UpdateGuestCountCommand, params: RequestParams = {}) =>
    this.request<UpdateGuestCountData, UpdateGuestCountError>({
      path: `/routes/dine-in-commands/update-guest-count`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Link additional tables to an existing DINE-IN order - Validates order exists and is DINE-IN - Validates tables exist and are available (not occupied) - Updates orders.linked_tables array - Updates pos_tables linking fields for each table - Logs TABLES_LINKED event to state history - Returns updated order with new linked tables Use Case: Large party needs multiple tables (e.g., Table 5 + Table 6 + Table 7)
   *
   * @tags dbtn/module:dine_in_commands
   * @name link_tables
   * @summary Link Tables
   * @request POST:/routes/dine-in-commands/link-tables
   */
  link_tables = (data: LinkTablesCommand, params: RequestParams = {}) =>
    this.request<LinkTablesData, LinkTablesError>({
      path: `/routes/dine-in-commands/link-tables`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Unlink a table from an existing DINE-IN order - Validates table is actually linked to the order - Cannot unlink the primary table (use cancel-order instead) - Updates orders.linked_tables array - Clears pos_tables linking fields for the table - Logs TABLE_UNLINKED event to state history - Returns updated order with updated linked tables Use Case: Party size reduced, no longer need extra table
   *
   * @tags dbtn/module:dine_in_commands
   * @name unlink_table
   * @summary Unlink Table
   * @request POST:/routes/dine-in-commands/unlink-table
   */
  unlink_table = (data: UnlinkTableCommand, params: RequestParams = {}) =>
    this.request<UnlinkTableData, UnlinkTableError>({
      path: `/routes/dine-in-commands/unlink-table`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Command: Clear/Reset a table back to VACANT status COMPLETE CLEANUP: - Marks orders as VOIDED (for test orders) - Deletes all customer tabs for the table - Unlinks from any linked tables - Resets pos_tables.status to AVAILABLE - Clears pos_tables.current_order_id
   *
   * @tags dbtn/module:dine_in_commands
   * @name clear_table
   * @summary Clear Table
   * @request POST:/routes/dine-in-commands/clear-table
   */
  clear_table = (data: ClearTableCommand, params: RequestParams = {}) =>
    this.request<ClearTableData, ClearTableError>({
      path: `/routes/dine-in-commands/clear-table`,
      method: "POST",
      body: data,
      type: ContentType.Json,
      ...params,
  ...
  /**
   * @description Get enriched dine-in order items with full menu metadata. JOINs dine_in_order_items with: - menu_items (descriptions, pricing, dietary info) - menu_categories (category names) - menu_assets (image URLs) - menu_item_variants (variant-specific data) - protein_types (protein names) Used by DineInFullReviewModal for rich visual display.
   *
   * @tags dbtn/module:dine_in_commands
   * @name get_enriched_order_items2
   * @summary Get Enriched Order Items
   * @request GET:/routes/dine-in-commands/orders/{order_id}/enriched-items
   * @originalName get_enriched_order_items
   * @duplicate
   */
  get_enriched_order_items2 = ({ orderId, ...query }: GetEnrichedOrderItems2Params, params: RequestParams = {}) =>
    this.request<GetEnrichedOrderItems2Data, GetEnrichedOrderItems2Error>({
      path: `/routes/dine-in-commands/orders/${orderId}/enriched-items`,
      method: "GET",
      ...params,
    });
  ...
  /**
   * @description POST version of get_customer_profile for JSON body requests. This endpoint accepts a JSON body with customer identifiers and returns the same data as the GET version. Designed for voice agents and webhooks.
   *
   * @tags customer-profile, dbtn/module:customer_profile_api
   ...
   *
   * @tags dbtn/module:test_voice_executor
   * @name test_voice_executor_health_check
   * @summary Test Voice Executor Health Check
   * @request GET:/routes/health
   */
  test_voice_executor_health_check = (params: RequestParams = {}) =>
    this.request<TestVoiceExecutorHealthCheckData, any>({
      path: `/routes/health`,
      method: "GET",
      ...params,
    });
