  ...
  useEffect(() => {
    ...
    const loadGoogleMaps = async () => {
      try {
        ...
        if (existingScript) {
          console.log('📍 Google Maps script found in DOM, waiting for initialization...');
          setIsLoading(true);
          ...
          const checkGoogle = () => {
            ...
            if (attempts < maxAttempts) {
              ...
              console.error('⏰ Timeout: Google Maps failed to load after 10 seconds');
          ...
          script.onload = () => {
            ...
            setTimeout(() => {
              if (window.google && window.google.maps && window.google.maps.places) {
                ...
                console.error('❌ Google Maps loaded but not fully available');
